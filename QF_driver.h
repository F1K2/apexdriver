...
namespace mem {
	...
	bool find_driver() {
		driver_handle = CreateFileW((L"\\\\.\\{d6579ab0-c95b-4463-9135-41gbcf16e4eg}"), GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, 0, NULL); //DRIVER COMM NAME
